...
// 일반 함수(예금, 출금, 정보출력) 추상 함수(적금, 해약)
    public void deposit(){
        System.out.println("(일반) 예금 함수 시작");
    }
    public void withdraw(){
        System.out.println("(일반) 출금 함수 시작");
    }
    public void getInfo(){
    ...
    public abstract String money(); // 문자열형 돈 추상함수
}
...
class MyBankAbstract extends BankAbstract	// MyBankAbstract에서 상속해 사용
{
    ...
    public void installmentSavings() {
        System.out.println("(추상) 적금 메서드 시작");}
    @Override
    public void cancellation() {
        System.out.println("(추상) 해약 메서드 시작");}
   @Override
   	public String money() {return null;}
}
...
public static void main(String[] args) {
    ...
    mybank.deposit();   // 추상 클래스의 (일반)예금함수 시작
    mybank.withdraw();  // 추상 클래스의 (일반)출금함수 시작
    System.out.println();
